...
## UI_PROFILE_ZOOMER_APPLIED_UI_COPY_STEP3

Exact applied UI-copy rows for Step 2.3. This section lists only the 79 replacements applied to the zoomer UI profile.
...
| TXT_0117 | Сдача принята — спокойнее. | Сдал. Спокойнее. | replace |
| TXT_0118 | «Сдать» без фактов — шум. | Без фактов это шум. | replace |
| TXT_0141 | Ты уже проголосовал. | Ты уже голосовал. | replace |
| TXT_0142 | Не хватает 💰. | Мало 💰. | replace |
| TXT_0143 | Реванш уже запрошен. | Реванш уже ждёт. | replace |
| TXT_0144 | Недоступно. Баттл не завершён. | Баттл не завершён. | replace |
| TXT_0148 | Кулдаун активен. | Кулдаун идёт. | replace |
| TXT_0149 | Не хватает 💰. | Мало 💰. | replace |
| TXT_0150 | Не хватает 💰. | Мало 💰. | replace |
| TXT_0151 | Уже было уважение сегодня этому персонажу. | Уже уважал сегодня. | replace |
| TXT_0152 | Цепочка A->B->A сегодня не работает. | A->B->A сегодня закрыта. | replace |
| TXT_0153 | Лимит уважения на сегодня исчерпан. | Лимит уважения исчерпан. | replace |
| TXT_0154 | Сейчас не получилось. Попробуй позже. | Не вышло. Позже. | replace |
| TXT_0155 | Ты отдал 1💰 | -1💰 | replace |
| TXT_0156 | Цель получила +1 ⭐ | Цель: +1⭐ | replace |
| TXT_0157 | Dev Mode disabled. | Dev Mode off. | replace |
| TXT_0158 | Dev Mode unlocked on this device. | Dev Mode on here. | replace |
| TXT_0159 | Incorrect Dev Mode PIN. | Wrong Dev PIN. | replace |
| TXT_0160 | Рано. Дай паузу. | Рано. Пауза. | replace |
| TXT_0164 | Не хватает 💰. | Мало 💰. | replace |
...
| `STEP4_2_104` | Полная UI-формулировка 104: Откроется на ⚡{energy} | Откроется на ⚡{energy} |
