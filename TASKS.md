...
- Goal: fix the start-root detection and stale overwrite path so the active visible root stays on the live profile resolver path and the Fix5 smoke can verify the live DOM route.
