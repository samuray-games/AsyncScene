...
- Added dev-only Safari command: `Game.__DEV.smokeToneProfilesStep46FutureExpansionHook()`.
- Smoke coverage verifies the hook/registry includes `ancient`, `classic`, `future`, `sciFi`, `medieval`, `empire`, and `galactic`, unsupported future profiles fall back safely to millennial, `millennial` remains millennial, `zoomer` remains zoomer, `alpha` remains alpha, no `undefined uiProfile` appears, and no year values are persisted.
- Served identity: `build_2026_06_14_step6_4_6_future_expansion_hook` / `step6_4_6_future_expansion_hook` / `step6_4_6_future_expansion_hook_smoke_v20260614_001`.
...
- Required Safari command: `Game.__DEV.smokeToneProfilesStep46FutureExpansionHook()`.
