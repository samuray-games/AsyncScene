...
- `TASK-INFRA-POST-R2-REPOSITORY-MEMORY-CLOSURE-20260719` — status: IN_PROGRESS; current phase: corrective review of PR #236 after durable-memory preservation fix.
