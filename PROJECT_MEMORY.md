...
- Refreshed the served runtime identity markers in `docs/index.html`, `AsyncScene/Web/dev/dev-checks.js`, and `docs/dev/dev-checks.js` to `build_2026_06_05_al` / `ad41fff`, matching the current short git hash.
