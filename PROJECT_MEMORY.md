...
- Added dev-only Safari smoke `Game.__DEV.smokeToneProfilesStep46FutureExpansionHookFix1()` with build identity `build_2026_06_14_step6_4_6_future_expansion_hook_fix1` / `step6_4_6_future_expansion_hook_fix1` / `step6_4_6_future_expansion_hook_fix1_smoke_v20260614_001`.
