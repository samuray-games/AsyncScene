...
BOOTSTRAP_ID: ASYNCHRONIA_CODEX_BRIDGE_ALIAS_V2_4
...
```markdown
<!-- ASYNCHRONIA_BRIDGE_ALIAS_V2_4_BEGIN -->
...
14. Return actual claim token and claim path separately.
15. Publish only the exact authorized immutable outbox and receipt.
16. At completion, tell the user to return to ChatGPT and write the same numbered command.
<!-- ASYNCHRONIA_BRIDGE_ALIAS_V2_4_END -->
```
