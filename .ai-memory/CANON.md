...
- Stage 7.1 user acceptance passed in iPhone Safari after PR #282 merge `f00317a022486566293b870f0540db5cbf1ef08c` and Pages build `1132995890`; the private-tab retest confirmed the legacy-save migration and repaired cache delivery.
