...
AUTHOR_ROLE: WORK
SOURCE_REVISION: MEMORY_REV 2026-07-14-0108-JST / origin-main b9c4a5bcf522da10c5a6592366e5462483653d95

### Repository evidence inspected

- Current main: `b9c4a5bcf522da10c5a6592366e5462483653d95`.
...
- Live project memory at `MEMORY_REV: 2026-07-14-0108-JST`.
...
1. Codex hardens repository bridge authority, canonical publication policy, validators, tests and the three-slot repair manifest on `infra/bridge-123-revalidation-repair-20260714`.
...
- only the exact repository control-plane files named in `03-codex-task.md`.
...
- Installed Asynchronia 1.0.9 is confirmed, so task preparation is unblocked.
