...
| `STEP4_2_017` | Полная UI-формулировка 017: Открой события. | Пока тихо. |
...
| `STEP4_2_038` | Полная UI-формулировка 038: Недоступно. | Пока закрыто. |
...
| `STEP4_2_101` | Полная UI-формулировка 101: Вызовов нет. | Раундов нет. |
| `STEP4_2_104` | Полная UI-формулировка 104: Откроется на ⚡{energy} | Нужно ⚡{energy} |
