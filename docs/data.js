...
Data.MAX_NPC_SHARE_CROWD = 1.0;
  ...
  battle_draw: "Толпа решает",
      ...
      teach_sent_dm: "Аргумент для {student}: {arg}. Цена {cost} 💰.",
      ...
      cop_report_accept: ["Я тебя понял. Проверяю информацию.", "Принял. Сейчас разберёмся."],
      cop_busy: ["Я сейчас занят, подойди позже.", "Сейчас не могу, оформляю другое дело."],
      cop_report_ok: ["Проверка сошлась. Я вмешался.", "Ты был прав. Я занялся этим."],
      cop_report_fail: ["Не подтвердилось. Осторожнее с обвинениями."],
  ...
  Data.COP_TEMPLATES = {
    intros: [
      "Добрый день, меня зовут {cop.fullName}, я на связи.",
    ...
    chatReplies: [
      "Принято, держу ситуацию под наблюдением.",
    ...
    scolds: [
      ...
      "Ты недосказал детали, а «Сдать» вызвало переполох.",
      "Сначала убедитесь, потом вызывайте копов.",
      "Не раздувайте ситуацию без оснований.",
      "«Сдать» без фактов разрушает доверие.",
      "Мы не можем реагировать на каждый слух.",
      "Помните: «Сдать» без фактов идет в отчет, проверяйте факты."
    ]
  };
...
`
  ...
  Data.NPC_CHAT_LINES = [
    ...
    "шумная площадь сегодня",
    "неловко вышло, но я смотрю",
    "давайте без истерик",
    ...
    "кто следующий",
    "ну давай, удиви",
    "площадь как лента, листаешь и не можешь остановиться",
