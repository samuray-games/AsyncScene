...
(() => {
  ...
  const SYSTEM_COPY_RU = Object.freeze({
    errors: Object.freeze({
      ...
      insufficientPoints: "Мало 💰",
      pointsLowBattle: "Мало 💰",
    ...
    warnings: Object.freeze({
      ...
      cooldownShort: "Пауза: активно",
      copCooldown: "Проверка: ожидание",
    ...
    notifications: Object.freeze({
      ...
      respectPaid: "Вы потратили 1 💰.",
      respectTargetRep: "Цель получила +1 ⭐.",
      voteAccepted: "Голос: принято",
      reportPending: "Проверка началась.",
      reportTrueReward: "Сдать {name}: +2💰.",
      reportOk: "Коп принял сообщение о {name}: +2 💰.",
      reportCompensationBundle: "+1⭐ +1💰",
      reportReturnAmount: "+{returnAmount}💰",
      trainingSent: "Аргумент: {teacher} → {student}.",
      rematchRequested: "{name}: реванш",
      escapePaid: "Уйти: 1💰",
      pointsDeltaRefund: "Возврат: +1💰",
      pointsDeltaRefundMajority: "Большинство: +1💰",
      pointsDeltaRemainderWin: "Остаток: +1💰",
      rematchCost: "Реванш: -{rematchCost}💰.",
      escapeVoteCost: "Уйти: -{escapeCost}💰",
      p2pTransferSent: "{target}: +{amount}💰.",
      p2pTransferReceived: "{target}: +{amount}💰",
    }),
    systemEvents: Object.freeze({
      ...
      battleChallenge: "{attackerName} [{attackerInf}]: вызов",
      npcBattleStart: "{a} вызывает {b}.",
      battleWin: "{winner} победил. {loser} проиграл.",
      battleResult: "{oppName}: {text}",
  ...
  const SYSTEM_PROFILE_TEXT_COPY = Object.freeze({
    ...
    alpha: Object.freeze({
      ...
      alpha_training_sent: "{teacher} → {student}: аргумент.",
      boomer_report_no: "Донос пустой: -5💰.",
      alpha_respect_paid: "Расход: 1💰",
      alpha_respect_target_rep: "Цель: +1⭐",
      alpha_report_pending: "Проверка",
      alpha_report_true_reward: "{name}: +2💰.",
    }),
  });
  const SYSTEM_PROFILE_TEXT_ROUTE_MAP = Object.freeze({
    ...
    "notifications.respectPaid": "alpha_respect_paid",
    "notifications.respectTargetRep": "alpha_respect_target_rep",
    "notifications.reportPending": "alpha_report_pending",
    "notifications.reportTrueReward": "alpha_report_true_reward",
  ...
  const SYSTEM_ECONOMY_TEXT_REASON_CONTRACT = Object.freeze([
    ...
    Object.freeze({ reason: "points_respect_cost", aliases: Object.freeze(["respect_cost"]), kind: "notifications", code: "respectPaid", currency: "points", direction: "debit", textProof: "потратили", reasonProof: "respect points cost transfer" }),
  ...
  Game.__DEV.smokeZoomerUiTextShorteningOnce = function smokeZoomerUiTextShorteningOnce(){
    ...
    const covered = Object.freeze([
      ...
      { category: 'toasts', source: 'SystemCopy.notifications.respectTargetRep', before: 'Цель получила +1⭐.', after: 'Цель получила +1 ⭐.', meaning: 'respect toast still says the target gained one reputation' },
