...
Data.MAX_NPC_SHARE_CROWD = 1.0;
  ...
  battle_draw: "Толпа решает",
      ...
      cop_report_ok: ["Проверка сошлась. Вмешался.", "Ты прав. Занялся этим."],
      cop_report_fail: ["Не подтвердилось. Проверь факты."],
  ...
  Data.COP_TEMPLATES = {
    ...
    warnings: [
      ...
      "Обстановка может сорваться. Держите дистанцию.",
      "Сообщайте детали, я среагирую.",
    ...
    chatReplies: [
      ...
      "Контролирую. Передавайте детали.",
    ...
    thanks: [
      "Спасибо за сдачу — стало спокойнее.",
      "Хорошая работа, так держать.",
      "Благодарю, район спокойнее.",
      ...
      "Спасибо за сдачу — улицы спокойнее."
    ],
    scolds: [
