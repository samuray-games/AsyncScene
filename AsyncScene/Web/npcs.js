  ...
  NPC.SAY = {
    ...
    bandit: {
      m: [
        ...
        "лучший ход для тебя это Свалить",
    ...
    mafia: {
      m: [
        ...
        "Мне важно, чтобы ты понимал последствия своих действий",
  ...
  const buildNpcSpeechTemplates = () => {
    ...
    const roleLines = {
      ...
      defeat: {
        ...
        bandit: ["не вывез, значит платишь вниманием", "слабый ход, {PLAYER}, соберись"],
