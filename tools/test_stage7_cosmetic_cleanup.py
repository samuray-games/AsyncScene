...
boot = (SOURCE / "ui/ui-boot.js").read_text(encoding="utf-8")
...
require("requestStartupNameToasts" in tone and "stage7_startup_stat_name_toasts_v5" in tone, "simultaneous startup name-toast path missing")
