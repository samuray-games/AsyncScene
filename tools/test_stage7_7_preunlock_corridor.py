...
assert "Вопросы по ситуации" in source
assert "Перейти к вопросам" in source
assert "После вопросов откроется полная игра" not in source
...
for index in [source_index, docs_index]:
    assert index.count("stage7_cosmetic_cleanup_20260808a") >= 2
